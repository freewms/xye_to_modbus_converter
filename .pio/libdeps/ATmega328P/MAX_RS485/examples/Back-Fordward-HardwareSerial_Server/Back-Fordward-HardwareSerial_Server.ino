/**
 * This example shows how to send & receive a message between 2 modules using any hardware serial port
 */
...
MAX_RS485 rs485(&Serial1, receiverEnablePin, driveEnablePin); // module constructor
